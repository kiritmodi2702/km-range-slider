...
import { Animated, PanResponder, View, ViewPropTypes, Text, StyleSheet } from 'react-native';
    ...
    <View {...restProps}>
      <View {...labelContainerProps}>
        ...
        <View style={styles.topLabel}>
          {!hideLeftRightLabel && <View style={styles.subContainer}>
            <Text style={{ ...styleLeftRightLable, color: low > min ? styleLeftRightLable.color : 'transparent', width: 20 }}>{min}</Text>
            <Text style={{ ...styleLeftRightLable, color: low < max ? styleLeftRightLable.color : "transparent" }}>{max}</Text>
          </View>}
          {labelView}
...
Slider.propTypes = {
  ...
  hideFloatingLabel: PropTypes.bool,
  hideLeftRightLabel: PropTypes.bool,
  styleLeftRightLable: PropTypes.object
};
